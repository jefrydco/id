...
Clang acts as a driver that runs source code through these stages. Each stage can be captured with a flag.
...
Example source used in the commands below:
...
[... truncated, hundreds of lines of expanded headers ...]
# 2 "hello.c" 2
...
[... truncated, attributes and metadata ...]
```
...
User configuration file directory: /Users/jefrydco/.config/clang
 "/opt/homebrew/Cellar/llvm/22.1.6/bin/clang-22" -cc1 -triple arm64-apple-macosx26.0.0 [... truncated, many -target-feature flags ...] -o /var/folders/8n/.../hello.o -x c hello.c
