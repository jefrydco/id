...
publishedAt: 2020-02-01T01:00:00.000Z
tags:
  - vuejs
  - reactivity
  - javascript
...
import ReactivityDemoPart2 from '@/components/demos/reactivity/ReactivityDemoPart2.astro';

> Read the first part here, [Create a Simplified Version of Vue.js Reactivity System - Part 1](/blog/create-reactivity-system-vuejs-javascript-part-1/)
...
<ReactivityDemoPart2 variant={11} />
...
<ReactivityDemoPart2 variant={12} />
...
```typescript twoslash {3,6}
class Watcher {
  taskList: Array<() => void> = []
  static task: (() => void) | null = null
}
```
...
```typescript twoslash {3-5}
declare class Watcher {
  static task: (() => void) | null
}
// ---cut---
function runner(task: () => void) {
  Watcher.task = task
  task()
  Watcher.task = null
}
...
<ReactivityDemoPart2 variant={13} />
...
<ReactivityDemoPart2 variant={14} />
...
<ReactivityDemoPart2 variant={15} />
