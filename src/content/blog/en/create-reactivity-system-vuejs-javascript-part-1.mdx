...
publishedAt: 2020-01-20T01:00:00.000Z
tags:
  - vuejs
  - reactivity
  - javascript
...
import ReactivityDemo from '@/components/demos/reactivity/ReactivityDemo.astro';

> Read the second part here, [Create a Simplified Version of Vue.js Reactivity System - Part 2](/blog/create-reactivity-system-vuejs-javascript-part-2/)
...
::video{src="/videos/2020-01-01-spreadsheet-average-reactivity-by-jefrydco.webm"}
...
![Vue.js Reactivity System Diagram by Evan You (Source: [Vue.js: Reactivity in Depth](https://vuejs.org/v2/guide/reactivity.html))](../../../assets/blog/2020-01-01-vuejs-reactivity-system-explained.jpg)
...
::video{src="/videos/2020-02-01-add-event-listener-effect-by-jefrydco-en.webm"}
...
::video{src="/videos/2020-02-01-change-via-console-does-not-affect-reactivity-by-jefrydco-en.webm"}
...
```typescript twoslash {2,8-9,12-13}
const human: Record<string, string> = { name: 'jefrydco' }
// ---cut---
let name = human['name']
...
```typescript twoslash
declare const human: Record<string, string>
// ---cut---
human.name
...
::video{src="/videos/2020-02-01-change-via-console-affect-reactivity-by-jefrydco-en.webm"}
