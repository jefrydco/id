...
publishedAt: 2021-04-24T01:00:00.000Z
tags:
  - vuejs
  - reactivity
  - javascript
...
import ReactivityVue3Demo from '@/components/demos/reactivity/ReactivityVue3Demo.astro';
...
Before this article, I also wrote about [Create a Simplified Version of Vue.js Reactivity System - Part 1](/blog/create-reactivity-system-vuejs-javascript-part-1/) and [Create a Simplified Version of Vue.js Reactivity System - Part 2](/blog/create-reactivity-system-vuejs-javascript-part-2/). So please make sure you already read them as well to get better understanding about the basic.
...
If we try to access a property that doesn't exist, TypeScript will show us an error:
...
::x{url="https://twitter.com/jtannady/status/981547257479778307"}
...
::video{src="/videos/2021-04-01-weakmap-garbage-collection.webm"}
...
::video{src="/videos/2021-04-01-reactivity-spreadsheet.webm"}
...
![Target Key Dependencies Diagram](../../../assets/blog/2021-04-01-target-key-dependencies.jpg)
...
![WeakMap Map Set Diagram](../../../assets/blog/2021-04-01-weakmap-map-set.jpg)
