...
declare var object: {
  ...
  array: number[];
  func: () => string;
  otherObject: { number: number; string: string; boolean: boolean; array: number[] };
}
// ---cut---
...
But this kind of code is not good because it can produce bugs like the following case:
...
The `greet` function has `ReferenceType` as follows:
...
```typescript twoslash
interface Cat { full: boolean }
interface CatConstructor { new (): Cat }
declare var Cat: CatConstructor
// ---cut---
var cat = new Cat()
```
...
```typescript twoslash
interface Cat { full: boolean; eat: () => void }
interface CatConstructor { new (): Cat }
declare var Cat: CatConstructor
// ---cut---
var cat = new Cat()
...
```typescript twoslash
function Human(
  this: { name: string; dateOfBirth: string; placeOfBirth: string; sex: string; address: string },
  name: string,
  dateOfBirth: string,
  placeOfBirth: string,
  sex: string,
...
```typescript twoslash
interface Human { name: string; dateOfBirth: string; placeOfBirth: string; sex: string; address: string }
interface HumanConstructor { new (name: string, dateOfBirth: string, placeOfBirth: string, sex: string, address: string): Human }
declare var Human: HumanConstructor
// ---cut---
...
```typescript twoslash
interface Human { name: string; dateOfBirth: string; placeOfBirth: string; sex: string; address: string }
interface HumanConstructor { new (name: string, dateOfBirth: string, placeOfBirth: string, sex: string, address: string): Human; prototype: Human }
declare var Human: HumanConstructor
// ---cut---
var human4 = {
  name: "Atun",
...
```typescript twoslash
declare var cat: { eat: () => void; meow: () => void }
declare var bird: { eat: () => void; fly: () => void }
// ---cut---
cat.eat()
// Animal eat...
...
```typescript twoslash
interface Cat { full: boolean; eat: () => void; meow: () => void }
interface CatConstructor { new (): Cat }
declare var Cat: CatConstructor
declare var cat: Cat
// ---cut---
