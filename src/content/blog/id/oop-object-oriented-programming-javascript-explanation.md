...
publishedAt: 2020-01-10T01:00:00.000Z
tags:
  - javascript
  - typescript
  - css
...
declare var objek: {
  ...
  array: number[];
  fungsi: () => string;
  objekLain: { angka: number; huruf: string; benarSalah: boolean; array: number[] };
}
// ---cut---
...
![window JavaScript](../../../assets/blog/2020-01-01-window-javascript-by-jefrydco.png)
...
![this JavaScript](../../../assets/blog/2020-01-01-this-javascript-by-jefrydco.png)
...
![this Object Null Raise Error JavaScript](../../../assets/blog/2020-01-01-this-object-null-raise-error-javascript-by-jefrydco.png)
...
![this Missing Immediately Invoked Function Expression JavaScript](../../../assets/blog/2020-01-01-this-missing-iife-javascript-by-jefrydco.png)
...
![this Missing Re-assignment JavaScript](../../../assets/blog/2020-01-01-this-missing-reassignment-javascript-by-jefrydco.png)
...
![this Function JavaScript](../../../assets/blog/2020-01-01-this-function-javascript-by-jefrydco.png)
...
![Avia B 534 by MLWatts and Airliners.net (Source: [Wikipedia: Avia B-534](https://en.wikipedia.org/wiki/Avia_B-534))](../../../assets/blog/2020-01-01-avia-b-534-by-mlwatts-and-airliners-net.jpg)
...
```typescript twoslash
interface Kucing { kenyang: boolean }
interface KucingConstructor { new (): Kucing }
declare var Kucing: KucingConstructor
// ---cut---
...
```typescript twoslash
interface Kucing { kenyang: boolean; makan: () => void }
interface KucingConstructor { new (): Kucing }
declare var Kucing: KucingConstructor
// ---cut---
var kucing = new Kucing()
...
```typescript twoslash
function Manusia(
  this: { nama: string; tanggalLahir: string; tempatLahir: string; jenisKelamin: string; tempatTinggal: string },
  nama: string,
  tanggalLahir: string,
  tempatLahir: string,
  jenisKelamin: string,
...
```typescript twoslash
interface Manusia { nama: string; tanggalLahir: string; tempatLahir: string; jenisKelamin: string; tempatTinggal: string }
interface ManusiaConstructor { new (nama: string, tanggalLahir: string, tempatLahir: string, jenisKelamin: string, tempatTinggal: string): Manusia }
declare var Manusia: ManusiaConstructor
// ---cut---
...
```typescript twoslash
interface Manusia { nama: string; tanggalLahir: string; tempatLahir: string; jenisKelamin: string; tempatTinggal: string }
interface ManusiaConstructor { new (nama: string, tanggalLahir: string, tempatLahir: string, jenisKelamin: string, tempatTinggal: string): Manusia; prototype: Manusia }
declare var Manusia: ManusiaConstructor
// ---cut---
var manusia4 = {
  nama: "Atun",
...
![prototype JavaScript](../../../assets/blog/2020-01-01-prototype-javascript-by-jefrydco.png)
...
![__proto__ JavaScript](../../../assets/blog/2020-01-01-proto-javascript-by-jefrydco.png)
...
```typescript twoslash
declare var kucing: { makan: () => void; meow: () => void }
declare var burung: { makan: () => void; terbang: () => void }
// ---cut---
kucing.makan()
// Binatang makan...
...
![Property Inheritance JavaScript](../../../assets/blog/2020-01-01-property-inheritance-javascript-by-jefrydco.png)
...
![this in Property Inheritance JavaScript](../../../assets/blog/2020-01-01-this-in-property-inheritance-javascript-by-jefrydco.png)
...
![Prototype Inheritance JavaScript](../../../assets/blog/2020-01-01-prototype-inheritance-javascript-by-jefrydco.png)
...
```typescript twoslash
interface Kucing { kenyang: boolean; makan: () => void; meow: () => void }
interface KucingConstructor { new (): Kucing }
declare var Kucing: KucingConstructor
declare var kucing: Kucing
// ---cut---
...
```typescript twoslash
class Binatang { kenyang = false }
class Kucing extends Binatang { meow() { console.log('Kucing meow...') } }
// ---cut---
var kucing = new Kucing()
...
![Capsule (Source: [Wikipedia: Capsule (pharmacy)](https://en.wikipedia.org/wiki/Capsule_(pharmacy)))](../../../assets/blog/2020-01-01-capsule-by-secretdisc-from-wikipedia.jpg)
