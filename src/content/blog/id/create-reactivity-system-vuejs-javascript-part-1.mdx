...
::video{src="/videos/2020-01-01-add-event-listener-effect-by-jefrydco-id.webm"}
...
::video{src="/videos/2020-01-01-reactivity-recalculation-automatically-by-jefrydco-id.webm"}
...
::video{src="/videos/2020-01-01-change-via-console-does-not-affect-reactivity-by-jefrydco-id.webm"}
...
const manusia: Record<string, string> = { nama: 'jefrydco' }
// ---cut---
...
```typescript twoslash
declare const manusia: Record<string, string>
// ---cut---
manusia.nama
...
```typescript twoslash
declare const keadaan: Record<string, number>
// ---cut---
...
::video{src="/videos/2020-01-01-change-via-console-affect-reactivity-by-jefrydco-id.webm"}
